...
format = \sanhao\center\bfseries,
 ...
 \newpage
   ...
   \cite{RN7}
   \newpage  
    \addcontentsline{toc}{section}{\hspace{-0.65cm}致谢}% 将其加入目录
\clearpage% 最好不要改
   \section*{致谢}

   这是致谢的内容
   \newpage  
    \addcontentsline{toc}{section}{\hspace{-0.65cm}参考文献}% 将其加入目录
\clearpage
   \bibliography{Library}
      \newpage
      \addcontentsline{toc}{section}{\hspace{-0.65cm}附录}% 将其加入目录
\clearpage
   \section*{附录}
   这是附录的内容
